...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    faq1Q: 'Is my JSON data safe when using json.lolisoft.eu?',
  ...
  pl: {
    ...
    faq1Q: 'Czy moje dane JSON są bezpieczne i prywatne na json.lolisoft.eu?',
  ...
  de: {
    ...
    faq1Q: 'Sind meine JSON-Daten bei json.lolisoft.eu sicher?',
  ...
  es: {
    ...
    faq1Q: '¿Mis datos JSON están seguros al usar json.lolisoft.eu?',
  ...
  fr: {
    ...
    faq1Q: 'Mes données JSON sont-elles sécurisées sur json.lolisoft.eu ?',
